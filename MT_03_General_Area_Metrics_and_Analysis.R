...
HEL_LU_raw <- read.csv("CSVs/Helsinki_Urban Atlas 2018.csv", sep = ",")  # Helsinki Urban Atlas 2018 200m buffer data 
CPH_LU_raw <- read.csv("CSVs/Copenhagen_Urban Atlas 2018.csv", sep = ",") # Copenhagen Urban Atlas 2018 200m buffer data

# Buffered data
HEL_LU_raw_200m <- read.csv("CSVs/Helsinki_Urban Atlas 2018_200m.csv", sep = ",")  # Helsinki Urban Atlas 2018 200m buffer data 
CPH_LU_raw_200m <- read.csv("CSVs/Copenhagen_Urban Atlas 2018_200m.csv", sep = ",") # Copenhagen Urban Atlas 2018 200m buffer data
...
# Buffered data
{
  ...
  {
    # Helsinki
    HEL_LU_categories_200m <- HEL_LU_raw_200m |> 
      # 1) Reclassification into overarching categories
      mutate(category_2018 = case_when(
        # Urban Fabric = 1
        code_2018 == 11100 | code_2018 == 11210 | code_2018 == 11220 | code_2018 == 11230 |
    ...
    # Copenhagen
    CPH_LU_categories_200m <- CPH_LU_raw_200m |> 
      # 1) Reclassification into overarching categories
      mutate(category_2018 = case_when(
        # Urban Fabric = 1
        code_2018 == 11100 | code_2018 == 11210 | code_2018 == 11220 | code_2018 == 11230 |
  ...
  {
    # Helsinki
    HEL_LU_grouped_200m <- HEL_LU_raw_200m |> 
      # 1) Reclassification into overarching categories
      mutate(category_2018 = case_when(
        # Urban Fabric = 1
        code_2018 == 11100 | code_2018 == 11210 | code_2018 == 11220 | code_2018 == 11230 |
    ...
    # Copenhagen
    CPH_LU_grouped_200m <- CPH_LU_raw_200m |> 
      # 1) Reclassification into overarching categories
      mutate(category_2018 = case_when(
        # Urban Fabric = 1
        code_2018 == 11100 | code_2018 == 11210 | code_2018 == 11220 | code_2018 == 11230 |
  ...
  # 3.3) Match reclassification tables and area for potential later use
  {
    HEL_LU_final_200m <- HEL_LU_categories_200m |> 
      left_join(HEL_LU_grouped_200m, by = "category_2018")
    
    CPH_LU_final_200m <- CPH_LU_categories_200m |> 
      left_join(CPH_LU_grouped_200m, by = "category_2018")
  }
}
...
# Helsinki - buffered data
if (!file.exists("CSVs/Helsinki_LU_Areas_200m.csv")) {
  write.csv(HEL_LU_final_200m, "CSVs/Helsinki_LU_Areas_200m.csv")
}

# Copenhagen - buffered data
if (!file.exists("CSVs/Copenhagen_LU_Areas_200m.csv")) {
  write.csv(CPH_LU_final_200m, "CSVs/Copenhagen_LU_Areas_200m.csv")
}
...
# Combined Pie Chart - buffered data
# NOTE: These pie charts show data for the 200m buffered administrative boundary!
{
  # extract category and area percent
  h1 <- HEL_LU_final_200m |> select(category_2018, area_percent) |> unique()
  c1 <- CPH_LU_final_200m |> select(category_2018, area_percent) |> unique()
